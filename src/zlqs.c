...
This should return a real number, it's a distance after all. 
But, that would have cascading effects on other functions.
So I will keep it as a complex number, the functions that use it mostly take the 
